const BP = {
    ...
    gamePlay: {
        ...
        showHideLevelMsg: function () {
            BP.ui.progressElm.innerHTML = `${this.bubblesPoppedPerLevel
                } шариков лопнул за ${BP.gamePlay.stopwatch.showDuration()}`;
            ...
            BP.ui.levelMsg.innerHTML = `Уровень ${BP.gamePlay.level}`;
